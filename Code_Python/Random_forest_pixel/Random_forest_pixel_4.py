# -*- coding: utf-8 -*-
"""
Created on Thu Jun 12 16:19:48 2025
...
# === 1. Paramètres ===
color_space = "RGB"  # Choix possible : "RGB", "LAB", "HSV"
image_path = "C:/Users/ASUS/Desktop/Point_ponctuel_bon/LAUT01_A1_20240523/DJI_20240523115611_0337_V1.JPG"
label_path = "C:/Users/ASUS/Desktop/Couche_ref/A_RASTER/RASTER_4_LAT01_A1.tif"
...
save_rgb = cv2.imwrite(os.path.join(output_dir, "prediction_RGB_4.png"), colored_bgr)
save_labels = cv2.imwrite(os.path.join(output_dir, "prediction_labels_RGB_4.png"), pred_uint8)

print("Sauvegarde 'prediction.png' :", "OK" if save_rgb else "ÉCHEC")
