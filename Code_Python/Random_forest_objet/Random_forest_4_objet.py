# -*- coding: utf-8 -*-
"""
Created on Fri Jun 13 11:39:08 2025
...
color_space = "HSV"  # Choix possibles : "RGB", "LAB", "HSV"

image_path = "C:/Users/ASUS/Desktop/Point_ponctuel_bon/LAUT01_B1_20240523/DJI_20240523114851_0117_V1.JPG" # Image de base
label_path = "C:/Users/ASUS/Desktop/Couche_ref/A_RASTER/RASTER_4_LAT01_B1.tif"    # Digitalisation
output_dir = "C:/Users/ASUS/Desktop/Couche_ref/A_RASTER_prediction_objet/LAT01_B1/4" # Chemin fichier enregistrement
os.makedirs(output_dir, exist_ok=True)

output_class_raster = os.path.join(output_dir, "classification_obia_HSV_4.tif")
output_color_raster = os.path.join(output_dir, "classification_colored_HSV_4.tif")
...
train_mask = segment_labels >= 0  # On inclut toutes les classes
...
color_map = {
    0: [194, 178, 128],   # sable
    1: [0, 100, 0],       # végétation aquatique (vert foncé)
    2: [128, 128, 128],   # substrat minéral
    3: [144, 238, 144]    # végétation rivulaire (vert clair)
}
